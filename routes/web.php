...
// Only allow managing 2FA if AUTHY_KEY is defined inside .env file
    ...
    Route::prefix('inventory')->group(function (){
        ...
        Route::get('used-vehicle', [
            'as' => 'inventory.used.vehicle',
            'uses' => 'InventoryController@searchUsedVechicle'
        ]);
        ...
        Route::get('calculator', 'InventoryController@calculator')->name('vehicle.calculator');
...
//        'middleware' => 'permission:image-statistics'
    ...
    Route::middleware('permission:delivery.manage')->group(function(){
        ...
        Route::get('delivery-schedule/ff-delivery','DeliveryScheduleController@FfDelivery')->name('ff-delivery');
        Route::post('delivery-schedule/ff-delivery','DeliveryScheduleController@addFfDelivery')->name('ff-delivery');
    });
   ...
   // });
    ...
    // guest tracking
    Route::get('guest-tracking/{location}','GuestTrackingController@index')->name('guest-tracking');
    Route::post('guest-tracking-save','GuestTrackingController@save')->name('guest.tracking.save');
    ...
    Route::post('vehicle-detail/{stock}/update-description','DashboardController@SavevehicleDescription')->name('vehicle.update-description');
    Route::get('qr-code/{stock}','DashboardController@pringQRcode')->name('qr-code');
