<nav class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-semi-dark navbar-shadow">
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="navbar-nav flex-row mt-sm-0">
                <li class="nav-item mobile-menu d-md-none mr-auto ml-sm-1"><a href="#" class="nav-link nav-menu-main menu-toggle"><i class="ft-menu font-large-1"></i></a></li>
                <li class="nav-item">
        ...
        <div class="navbar-container content">
            <div id="navbar-mobile" class="collapse navbar-collapse">
                ...
                <span class="avatar avatar-online">
                  <img src="{{ auth()->user()->gravatar() }}" alt="avatar"><i></i></span>
                            <span class="user-name">{{ auth()->user()->first_name }} {{ auth()->user()->last_name }}</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            @if(auth()->user()->hasRole('Admin') || auth()->user()->hasRole('superadmin'))
                            <a href="{{ route('user.edit',auth()->user()->id) }}" class="dropdown-item"><i class="ft-user"></i> Edit Profile</a>
                            ...
                            <a href="{{ url('logout') }}" class="dropdown-item"><i class="ft-power"></i> Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
