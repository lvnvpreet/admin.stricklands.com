<div class="panel panel-default">
    ...
    <div class="panel-body avatar-wrapper">
        ...
        <div id="avatar"></div>
        <div>
            <img class="avatar-edit avatar-preview" src="{{ $edit ? $user->present()->avatar : url('assets/img/profile.png') }}">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4 avatar-source" id="no-photo"
                         data-url="{{ $updateUrl }}">
                        <img src="{{ url('assets/img/profile.png') }}" class="img-circle" style="max-width: 98%;">
