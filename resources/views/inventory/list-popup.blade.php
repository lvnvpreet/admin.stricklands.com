                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <span class="infotext">{{ number_format($vehicle->fldOdometer,0,'.',',') }}<br /></span>
                            <strong class="text-info">
                                <span class="infotext">Price:</span>
                            </strong>
                            <span class="infotext"> ${{ number_format($vehicle->fldRetail,0,'.',',') }}<br /><br></span>
...
//						echo "this is the options " . $option;
                                ...
                                <span class="infotext"><strong class="text-info">Location:</strong>
                                    {{ $vehicle->fldLocationCode }}</strong></strong><br>
                                </span>
                                <span class="infotext">
                                    <strong class="text-info">Website URL:</strong>
