                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 30px;">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                <input id="be_safe" type="text" class="form-control" placeholder="Be Safe" oninput="financeProgram(this)" value="398" >
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 5px;">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                <input id="ppsa" type="text" class="form-control" placeholder="PPSA" oninput="financeProgram(this)" value="66">
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 5px;">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                <input id="licence" type="text" class="form-control" placeholder="Licence" oninput="financeProgram(this)" value="32">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- <div class="row" style="margin-top: 5px;">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                ...
                                <input id="gst" type="text" class="form-control" placeholder="GST" value="0.06" oninput="financeProgram(this)">
                            </div>
                        </div>
                    </div> -->
                    <div class="row" style="margin-top: 5px;">
                        <div class="col-6">HST</div>
                        <div class="col-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fas fa-percent"></i></span>
                                <input id="pst" type="text" class="form-control" placeholder="HST" value="13" oninput="financeProgram(this)">
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 5px;">
                    ...
                    <div class="row" style="margin-top: 5px;">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                ...
                                <select class="form-control" id="interest_rate" onchange="financeProgram(this)">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top:30px">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                <input id="cash_be_safe" type="text" class="form-control" placeholder="Be Safe" oninput="cashDeal(this)" value="398">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top:30px">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                <input id="cash_licence" type="text" class="form-control" placeholder="Licence" oninput="cashDeal(this)" value="32">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- <div class="row" style="margin-top:5px">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                <input id="cash_gst" type="text" class="form-control" placeholder="GST" oninput="cashDeal(this)"  value="0.06">
                            </div>
                        </div>
                    </div> -->
                    <div class="row" style="margin-top:5px">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                <input id="cash_pst" type="text" class="form-control" placeholder="HST" oninput="cashDeal(this)" value="13">
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    <script>
        ...
        function cashDeal(data) {
            ...
            //let gst= parseFloat($("#cash_gst").val()?$("#cash_gst").val():0);
            let pst= parseFloat($("#cash_pst").val()?$("#cash_pst").val():0);
            ...
            //let gst_total= (subTotal*gst)/100;
            let pst_total= (subTotal*pst)/100;
        ...
        function financeProgram(data){
            ...
            //let gst = parseFloat($("#gst").val()?$("#gst").val():0);
            let pst = parseFloat($("#pst").val()?$("#pst").val():0);
            ...
            jQuery("#total_tax").val((subTotal+pst_total+ppsa+licence+lien).toFixed(2));
