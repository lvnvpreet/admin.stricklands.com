                            ...
                            @foreach ($vehicles as $vehicle)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <div>
                                        <a target="_blank" href="{{ route('vehicle-details',$vehicle->fldStockNo) }}" data-toggle="tooltip" data-html="true" data-placement="right" 
                                            title="

                                            {{ $modelno }} | STK#:{{ $vehicle->fldStockNo }} <br/><br/><b>Notes:-</b> {{ wordwrap($vehicle->fldComments, 45, "<br />\n") }}
...
<!--                                                  - {{ $vehicle->fldKey1 }}  -->
                                            ...
                                            @endif
                                             @if($vehicle->fldKey1 == 'SM')
                                                    | The shops will not touch this vehicle. The wholesaler will arrange to have this vehicle scrapped as soon as possible. 
                                            @endif
                                            @if($vehicle->fldKey1 == 'WAIS')
                                                    | Advertising Purposes. The shops will not touch this vehicle.
                                            @endif
                                            @if($vehicle->fldKey1 == 'WSS')
                                                    | Wholesale Shipping. The shops will not touch this vehicle.
                                            @endif
                                            @if($vehicle->fldKey1 == 'AS')
                                                    | This vehicle has not had a shop appraisal yet and priced strictly without a safety. 
                                            @endif
                                            @if($vehicle->fldKey1 != 'SM')
                                            @if($vehicle->fldKey1 != 'AS')
                                            ...
                                            @if($vehicle->fldCode == 'SS')
                                                    | This vehicle has been appraised and can be sold AS IS.
                                            @endif
                                            @endif
                                            @if($vehicle->fldKey1 == 'ASS')
                                                    | Vehicle safety has been completed, it can only be sold Simply Safety. 
                                            @endif
                                            ...
                                            {{ substr($modelno, 0, 40) }}
                                                    ...
                                                    <strong> <span >|| </span>
                                           @if($vehicle->fldCode != "P")
                                                <span style="color:blue">{{ $vehicle->fldCode }} </span>
                                                @else 
                                            @endif
                                            @if($vehicle->fldKey1 != "")
                                                <span style="color:orange"> - {{ $vehicle->fldKey1 }} </span>
                                            @endif
                                            @if($vehicle->fldCode == "P")
                                    ...
                                    <td>
                                        ...
                                        $timers = $vehicle->timers()->where(function($query){
                                        ...
                                        if($timers->count()){
                                            $v_datereceived = $timers->first()->checkin_date;
                                        }else{
                                    ...
                                    {{-- <td @if($vehicle->fldRetail <= 42) class="red" @endif> @if($vehicle->fldRetail <= 42)  @else {{ $vehicle->fldRetail }} @endif</td> --}}
