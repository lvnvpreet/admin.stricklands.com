...
class Deliveryff extends Model
{
    use FormAccessible;
    /**
    ...
    protected $fillable = [
        ...
        'fld_trade_mileage','fld_trade_vin','fld_trade_userid','fld_trade_trim','fld_trade_cost','fld_trade_status','fld_trade_retail','fld_display_trade','fld_trade_stock','fld_trade_acv','fld_trade_cylinder','fld_trade_transmission',
        'fld_trade_drive','fld_trade_type','fld_trade_interior','fld_trade_exterior','fld_trade_options','fld_trade_notes',
        'protection','fld_products','fld_license','lisc_prep','fld_rin','file_prep','s_w_o','s_p_tech','s_tech',
        's_emmision','s_safe','s_recheck','fld_notes','al_notes','d_who','d_w_o','d_keys','d_complete','d_time','fld_posted'
    ];
